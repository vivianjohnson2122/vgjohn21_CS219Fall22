...
public class LoopExercises {
     ...
     * the parameter n. mod ten - last digit divide ten - next digit
     *
     * count7s(1727337) = 3
     * count7s(1234) = 0
     * count7s(777777) = 6
     ...
     *  multiple means that that number can be divided by original number with no remainder
...
n
    ...
    public static void main(String[] args) {
        // checking checksum() and appendChecksum()
        System.out.println(checksum(4198) == 2);
        System.out.println(appendChecksum(91217) == 912170);
        System.out.println(appendChecksum(91217) != 912179); // negative test - should still come back true

        // checking count7s()
        System.out.println(count7s(1237783) != 3);
